...
const Page = () => {
  const invitations = [
    {
      icon: "PB",
      name: "Peculiar Badejo",
      email: "peculiarbadejoemailaddress@gmail.com",
      date: "Feb 6, 11:43 AM",
    },
    {
      icon: "OO",
      name: "Olamide Oni",
      email: "olamideoni22@gmail.com",
      date: "Feb 6, 11:43 AM",
    },
    {
      icon: "TO",
      name: "Tolu Olalekan",
      email: "toluola1@gmail.com",
      date: "Feb 6, 11:43 AM",
    },
  ];
  ...
  const handleReview = () => {
    ...
    router.push("/dashboard/session/1/review");
  };
      ...
      <div className={styles["middle-section"]}>
        <div className={styles["container"]}>
          ...
          <div className={styles["body-container"]}>
            <p>
              1. Develop a To-Do List web application using React for the
              frontend, PHP for the backend, and MySQL for the database. The
              application should allow users to add, complete, and delete tasks.
              Implement state management in React to handle the list of tasks
              dynamically, create a PHP API to manage CRUD operations, and store
              tasks in a MySQL database to ensure persistence across sessions.
            </p>
            <p>
              2. Implement a filtering feature in the To-Do List application
              that allows users to view All, Completed, or Pending tasks. Modify
              the frontend to include filter options and update the backend to
              support retrieving tasks based on their status.
            </p>
            <div className={styles["invitation-status"]}>
              ...
              <div>
                <LuLoader />3 pending invitations
              </div>
            </div>
          </div>
          {show && !access && (
          ...
          {show && access && (
            <div className={styles["table-container"]}>
              ...
              <div className={styles["table-head"]}>
                ...
                <div className={styles["head-date-time"]}>
                  {" "}
                  Date and time submitted
                </div>
                <div className={styles["head-approval"]}> Approval</div>
              </div>
              {submissions.map((student, index) => (
                <div key={index} className={styles["table-row"]}>
                  <div className={styles["row-name"]} onClick={handleReview}>
                    <div
                      className={styles["circle"]}
                      style={{ backgroundColor: getRandomHexColor() }}
                    >
                  ...
                  <div className={styles["row-date-time"]}>
                    {student.dateTime}
                  </div>
                  <div className={styles["row-approval"]}>
                    {student.approval}
                  </div>
                </div>
              ))}
      ...
      <div className={styles["right-section"]}>
        <div className={styles["box"]}>
          <div className={styles["validity"]}>
            ...
            <div
              ...
              style={{ backgroundColor: invitation ? "" : "#969696" }}
              onClick={toggleInvitation}
            >
              <div
                className={styles["toggle-circle"]}
                style={{ marginLeft: invitation ? "auto" : "0" }}
              ></div>
            </div>
          </div>
          ...
          <div className={styles["link"]}>
            ...
            <span onClick={handleCopy}>
              {copied ? "Copied!" : "Copy"} <PiCopySimpleFill />
            </span>
          </div>
        ...
        <div className={styles["box"]}>
          <div className={styles["open-access"]}>
            ...
            <div
              className={styles["toggle-container"]}
              style={{ backgroundColor: access ? "" : "#969696" }}
              onClick={toggleAccess}
            >
              <div
                className={styles["toggle-circle"]}
                style={{ marginLeft: access ? "auto" : "0" }}
              ></div>
            </div>
          </div>
        ...
        <div className={styles["box"]}>
          <div className={styles["session-outgoing"]}>
            ...
            <div
              className={styles["toggle-container"]}
              style={{ backgroundColor: session ? "" : "#969696" }}
              onClick={toggleSession}
            >
              <div
                className={styles["toggle-circle"]}
                style={{ marginLeft: session ? "auto" : "0" }}
              ></div>
            </div>
          </div>
