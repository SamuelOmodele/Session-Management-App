        ...
        <div className={styles["modal-body"]}>
          ...
          <div className={styles["sidebar"]}>
            ...
            <div className={styles["menu"]}>
              <div
                className={styles["circle-no"]}
                id={formstep >= 5 ? styles["active"] : styles[""]}
              >
                {formstep > 5 ? <FaCheck /> : 5}
              </div>
              <p
                className={
                  formstep >= 5
            ...
            {formstep === 1 && (
              <div className={styles["content1"]}>
                <div className={styles["group"]}>
                  ...
                  >
                    Python{" "}
                    {langaugeIndexList.includes(1) && <IoClose size={18} />}{" "}
                  </div>
                  <div
                    className={
                      langaugeIndexList.includes(2)
                        ? styles["active-language"]
                        : styles["language"]
                    }
                    onClick={() => addtolist(2)}
                  >
                    MySQL{" "}
                    {langaugeIndexList.includes(2) && <IoClose size={18} />}{" "}
                  </div>
                  <div
                    className={
                      langaugeIndexList.includes(3)
                        ? styles["active-language"]
                        : styles["language"]
                    }
                    onClick={() => addtolist(3)}
                  >
                    C# {langaugeIndexList.includes(3) && <IoClose size={18} />}{" "}
                  </div>
                  <div
                    className={
                      langaugeIndexList.includes(4)
                        ? styles["active-language"]
                        : styles["language"]
                    }
                    onClick={() => addtolist(4)}
                  >
                    Matlab{" "}
                    {langaugeIndexList.includes(4) && <IoClose size={18} />}{" "}
                  </div>
                </div>
                <div className={styles["group"]}>
              ...
              <div className={styles["content1"]}>
                <div className={styles["group"]}>
                  ...
                  <select name="" id="" style={{ width: "100%" }}>
                    <option value="">
                      Single work group for the entire session
                    </option>
                  </select>
                </div>
                <div className={styles["group"]}>
